...
static __inline__ __host__ __device__ short3 make_short3(short x, short y,
                                                         short z) {
  short3 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ short4 make_short4(short x, short y,
                                                         short z, short w) {
  short4 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ int4 make_int4(int x, int y, int z,
                                                     int w) {
  int4 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ long3 make_long3(long int x, long int y,
                                                       long int z) {
  long3 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ long4 make_long4(long int x, long int y,
                                                       long int z, long int w) {
  long4 t;
  t.x = x;
  t.y = y;
  t.z = z;
...
static __inline__ __host__ __device__ float3 make_float3(float x, float y,
                                                         float z) {
  float3 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ float4 make_float4(float x, float y,
                                                         float z, float w) {
  float4 t;
  t.x = x;
  t.y = y;
...
static __inline__ __host__ __device__ longlong1
make_longlong1(long long int x) {
  longlong1 t;
  t.x = x;
  return t;
}

static __inline__ __host__ __device__ ulonglong1
make_ulonglong1(unsigned long long int x) {
  ulonglong1 t;
  t.x = x;
  return t;
}

static __inline__ __host__ __device__ longlong2
make_longlong2(long long int x, long long int y) {
  longlong2 t;
  t.x = x;
  t.y = y;
  return t;
...
static __inline__ __host__ __device__ ulonglong2
make_ulonglong2(unsigned long long int x, unsigned long long int y) {
  ulonglong2 t;
  t.x = x;
  t.y = y;
  return t;
