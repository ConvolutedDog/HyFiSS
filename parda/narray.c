...
void narray_append_val(narray_t *na, const void *value) {
  ...
  memcpy((char *)na->data + na->len, value, na->element_size);
...
void narray_print(narray_t *na, void (*show_element)(void *, int, FILE *),
                  FILE *fp) {
...
narray_t *narray_heaparray_new(void *data, const unsigned len,
