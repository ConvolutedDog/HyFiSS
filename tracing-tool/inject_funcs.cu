...
instrument_inst(int pred, int pc, int opcode_id, int is_mem_inst,
                uint64_t addr1, int mref_id, uint64_t addr2, int dst_oprnd,
                int dst_oprnd_type, int src_oprnd1, int src_oprnd1_type,
                int src_oprnd2, int src_oprnd2_type, int src_oprnd3,
                int src_oprnd3_type, int src_oprnd4, int src_oprnd4_type,
                int src_oprnd5, int src_oprnd5_type, int pred_num,
                int isPredNeg, int isPredUniform, uint64_t pchannel_dev) {
